...
{ 
  ...
  public static void main(String[] args)
  {
    ...
    */	 
	Nivell3 objNivell3 = new Nivell3();
	
    // Nivell3Fase1: Les variables estan creades a nivell d'instancias i els arrays inicialitzats al metode. 
	objNivell3.Nivell3Fase1();

	//Nivell3Fase2
	objNivell3.Nivell3Fase2();
	
	//Nivell3Fase3
    objNivell3.Nivell3Fase3();
			  
    //Nivell3Fase1: Mostrar una posible opció de pagament  
   	objNivell3.nivell3Fase1ComPagar();    
    
  }
  
  
  /**
   * Nivell3Fase1: Implementacio requeriments
   */
  public void Nivell3Fase1()
  ...
  /**
   * Nivell3Fase2:  Implementacio requeriments
   */
  public void Nivell3Fase2()
  {
	...
	{ 
	  ...
	  { mostrarPlatsMenu(); // Mostrar els arrays plats + preus
	    ...
	    // __Nivell3__ Exercici: Crea  excepcions  personalitzades amb fitxers nous e implementa-les al codi actual.  
	    ...
	    { strInput = inputScanner.nextLine();
          ...
          { throw new Nivell3CustomizedException("Opció incorrecta.");
          }
          else
          { dValInput = Integer.parseInt(strInput);
            if( (dValInput<=-1) || (dValInput>mPlats.length) ) 
            { throw new Nivell3CustomizedException("El plat "+dValInput+" no es plat valid de la llista ni cap opció de selecció.");
   		    }
          }
	    }
	    catch(Nivell3CustomizedException ex)
	    { System.out.println("EXCEPCIO TIPUS : "+ ex.getClass().getCanonicalName());
  ...
  /**
   * Nivell3Fase3 :Implementacio requeriments  
   */
  private void Nivell3Fase3()
  {
  ...
  { int seguirMenjant = -1;
    ...
    { System.out.println("Seguir Menjant? ((1:Si / 0:No)");
      ...
      { strInput = inputScanner.nextLine();
        ...
        { throw new Nivell3CustomizedException("La opció "+strInput+" no es una entrada valida.");        
        }
      }
      catch(Nivell3CustomizedException ex)
      { System.out.println("EXCEPCIO TIPUS : "+ ex.getClass().getCanonicalName());
   ...
   */
  public void nivell3Fase1ComPagar()
